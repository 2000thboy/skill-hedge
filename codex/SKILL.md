---
name: skill-hedge
description: Security vulnerability scanner for vibe-coded projects. Detects SQL injection, command injection, XSS, path traversal, hardcoded secrets, SSRF, and other common attack patterns in AI-generated code. Triggers when user asks to "scan security", "check vulnerabilities", "find injection bugs", "security audit", "check for SQL injection", "review code security", or runs /skill-hedge.
argument-hint: "[path] [--format=json|md] [--severity=low|medium|high|critical] [--lang=js,py,ts,java,php,go,rb]"
user-invocable: true
---

# Skill-Hedge — Security Counterparty for AI-Generated Code
